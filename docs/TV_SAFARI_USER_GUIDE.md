...
> **GitHub Wiki:** A published copy lives at [TV Safari (wiki)](https://github.com/roto31/TV-Safari/wiki/TV-Safari). After changing behavior or diagrams here, update **`docs/wiki/TV-Safari.md`** and push to the wiki repo per **`docs/wiki/WIKI_SYNC.md`**. Policy: **`LESSONS_LEARNED.md` §28** and skill **`tv-safari-documentation-sync`**.
